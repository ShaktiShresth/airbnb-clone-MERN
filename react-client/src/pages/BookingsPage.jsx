    ...
    <div className="px-4 pt-4 lg:px-40">
        ...
        {bookings?.length > 0 &&
          visibleBookings.map((booking) => (
            <Link
              ...
              key={booking._id}
              className="flex gap-4 bg-gray-100 hover:bg-gray-200 rounded-2xl overflow-hidden cursor-pointer text-sm md:text-xl transition ease-in hover:delay-100"
            >
              <div className="w-48 h-28">
                <PlaceImage place={booking.place} />
              </div>
              <div className="pr-4 py-3 grow overflow-hidden">
                <h2 className="font-bold truncate md:font-semibold">
                  {booking.place.title}
                </h2>
                <BookingDates
                  booking={booking}
                  className="mt-2 py-2 border-gray-300"
                />
                <div className="flex gap-2 items-center text-sm lg:text-base overflow-hidden truncate">
                  ...
                  nights <span className="font-semibold"> | </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
      ...
      {/* {bookings?.length === 0 && (
        <div className="mt-8 text-gray-400 py-40 bg-gradient-to-r from-gray-100 to-gray-200 text-center">
          ...
          <p>
            You can check various places available according to your preferences
            and plan it right away by booking it.
          </p>
        </div>
      )} */}
