    ...
    <div className="py-4 px-4 lg:px-40">
      ...
      <div className="text-center my-6 mb-2 text-sm md:text-base">
        <Link
          ...
          className="bg-primaryColor rounded-full text-white py-2 px-6 inline-flex gap-1 items-center hover:bg-primaryHoverColor"
        >
          <svg
        ...
        {places.length > 0 &&
          visiblePlaces.map((place, index) => (
            <Link
              ...
              key={index}
              className="flex gap-4 p-4 rounded-2xl bg-gray-100 cursor-pointer mb-3 hover:bg-gray-200 transition ease-in hover:delay-150"
            >
              <div className="flex w-32 h-32 bg-gray-300 grow shrink-0">
                <PlaceImage place={place} />
              </div>
              <div className="grow-0 shrink overflow-hidden">
                <h2 className="text-xl md:text-2xl font-bold md:font-semibold truncate">
                  {place.title}
                </h2>
                <p className="mt-2 text-sm text-gray-500">
                  {place.description.slice(0, 189) + "... more"}
                </p>
