  ...
  return (
    <div className="mt-4 flex justify-around items-center grow">
        ...
        <form className="max-w-md mx-auto mt-4" onSubmit={handleLoginSubmit}>
            ...
            />
            <button className="bg-primaryColor w-full text-white p-2 rounded-2xl hover:bg-primaryHoverColor">Continue</button>
            <ToastContainer />
            <div className="text-center pt-3 text-sm"><Link to={'/reset'} className="text-gray-400 hover:underline hover:text-primaryHoverColor">Forgot Password?</Link></div>
            ...
            <div className="text-gray-400 text-center">Don't have an account yet? <Link to={'/register'} className="underline text-black hover:text-primaryHoverColor">Register</Link></div>
        </form>
        </div>
    </div>
  )
