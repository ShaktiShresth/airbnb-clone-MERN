    ...
    <div className="px-4 pt-8 lg:px-20 bg-gray-50 text-sm md:text-base">
      ...
      <div className="mt-8 mb-4 grid gap-8 grid-cols-1 md:grid-cols-[2fr_1fr]">
        <div>
            ...
            <div>
                <span className="font-semibold">Check-in (24hrs):</span> {place.checkIn} <br />
                <span className="font-semibold">Checkout (24hrs):</span> {place.checkOut} <br />
                <span className="font-semibold">Maximum number of guests:</span> {place.maxGuests} <br />
            </div>
        </div>
        <div>
