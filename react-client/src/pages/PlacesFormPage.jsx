...
export default function PlacesFormPage() {
  ...
  const inputHeader = (text) => {
    return <h2 className="mt-4 text-xl truncate">{text}</h2>;
  };
  const inputDescription = (text) => {
    return <p className="text-sm text-gray-500 truncate">{text}</p>;
  };
  ...
  async function savePlace(ev) {
    ...
    if (
      ...
      toast.warning(
        "Please enter all the required info to add the place to your account.",
        {
