    ...
    <div className="px-4 pb-4 pt-4 border-b-2 sticky lg:px-20">
      <header className="flex justify-between">
        <Link to={"/"} className="flex items-center gap-1 text-primaryColor">
          ...
          <span className="font-extrabold text-2xl tracking-tighter block">
            airbnb
          </span>
        </Link>
        ...
        <div className="hidden sm:flex gap-3 border border-gray-200 rounded-full py-3 px-4 shadow-md shadow-gray-200 hover:shadow-gray-300 transition ease-in-out delay-50 cursor-pointer">
          <div className="font-bold text-sm truncate sm:text-base">
            Anywhere
          </div>
          ...
          <div className="border-l border-gray-300"></div>
          <div className="text-gray-500 text-sm font-light truncate sm:text-base">
            Add guests
          </div>
        ...
        <div className="flex items-center">
          <div className="hidden absolute right-60 cursor-pointer xl:flex items-center">
            <div className="py-2 px-3 font-semibold text-bold hover:bg-gray-100 rounded-full tracking-tighter">
              Airbnb your home
            </div>
          ...
          <Link
            ...
            to={parsedData ? "/account" : "/login"}
            className="flex items-center gap-2 border border-gray-200 rounded-full py-2 px-2 hover:shadow-md shadow-gray-300 transition ease-in-out delay-50"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <div className="block font-semibold">
              {!!parsedData && <div>{parsedData.name.split(" ")[0]}</div>}
            </div>
          </Link>
        </div>
      </header>
